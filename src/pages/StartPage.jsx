  ...
  return (
    <div className="min-h-screen">
      <div className="relative">
        ...
        <p className="absolute bottom-0 text-center text-gray-200 text-sm p-4 right-1/2 transform translate-x-1/2">
      ...
      <div className="mt-8 mb-8 p-12 w-2/3 text-left  bg-white-400 flex flex-col mx-auto">
      ...
      <div className="relative">
        <img
          ...
          src="homepic2.jpg"
        />
        <div className="flex  flex-col  absolute top-1/3  items-center right-1/2 transform translate-x-1/2">
          <p className="text-3xl text-white ">REQUEST A FREE TRIAL WORKOUT</p>
          <p className="text-2xl w-3/4  text-white p-4 mt-4 text-center">
